...
- **CAP-11 Reason Code**
  ...
  - **success:** 임의 신청 1건에 대해 완성된 한국어 설명 문장을 포함한 사유 최대 3개가 반환된다. *(개정 2026-07-16, Story 2.2 리뷰: 실제 불리한 요인(점수손실/SHAP > 0)만 사유로 인정 — 전 변수가 안전한 신청 건은 0건 반환이 올바른 동작. 0점 손실·위험감소 요인을 "불리 사유"로 채워 넣는 것이 오설명이었음. API_SPEC v0.3에 동일 반영.)*
